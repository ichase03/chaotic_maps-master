...
#%%
# 蛛网图绘制
fig, axes = plt.subplots(2, 2, figsize=(14/2.54, 9/2.54))
...
plt.subplots_adjust(left=0.11, right=0.92, bottom=0.12, top=0.93)
plt.savefig("../pic/sin_cobwebs.png", dpi=300)
plt.show()
...
# 相关控制参数
param_var_range = np.linspace(0.6,1,800)
param_seqnum = 1
y_points = 500
dropped_steps = 2000
chaotic_dim_num = 1
...
# 绘图
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(14/2.54, 6/2.54))
ax1.plot( para_list,y0_list, "r,", linewidth=0.3)
# ax1.set_title("Bifurcation Diagram:x",fontsize=plt_sub_title_fontsize)
ax1.set_title("Bifurcation Diagram:x")
...
# plt.subplots_adjust(left=0.05 ,right=0.95, bottom=0.07, top=0.88)
plt.tight_layout()
plt.subplots_adjust(bottom=0.20)
plt.savefig("../pic/sin_Bif_LE.png", dpi=300)
plt.show()
