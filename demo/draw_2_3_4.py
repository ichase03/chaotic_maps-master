...
plt.rcParams["font.family"] = "Times New Roman"  # 使用衬线字体

parameters_init = np.array((0.1,0.75))

# 相关控制参数
param_var_range_start = 0.1
param_var_range_end = 1
...
# 绘图
fig, (ax1, ax2, ax3) = plt.subplots(1, 3, figsize=(15/2.54, 4/2.54))
ax1.plot( xtate0_list, 'b-')
...
fig.subplots_adjust(left=0.06 ,right=0.98, bottom=0.15, top=0.88,wspace=0.27)
# fig.subplots_adjust(left=0.05 ,right=0.98)

plt.savefig("PIC_2_3_4_LOGISTIC.png", dpi=300)
plt.show()